...
export class SessionClient extends APIClientBase {
    ...
    private getSessionTabsWithCallbacks(forTabType: string | null | undefined, onSuccess?: (result: void) => void, onFail?: (exception: string | string | string, reason: string) => void) {
    ...
    protected processGetSessionTabs(xhr: any): void | null {
        const status = xhr.status;
    ...
    private getSessionTabLabelsWithCallbacks(id: string, forTabType: string | null | undefined, onSuccess?: (result: void) => void, onFail?: (exception: string | string | string, reason: string) => void) {
    ...
    protected processGetSessionTabLabels(xhr: any): void | null {
        const status = xhr.status;
