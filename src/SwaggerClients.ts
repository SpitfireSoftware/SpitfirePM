...
export class ExcelToolsClient extends APIClientBase {
     ...
     * @param templateId (optional) Key of template or empty key
     * @param timeLimit (optional) Time Limit in minutes
     */
    postExcelExport(exportFrom: string, exportRequest: ExportRequest, templateId?: string | null | undefined, timeLimit?: number | undefined) {
        return new Promise<string>((resolve, reject) => {
            this.postExcelExportWithCallbacks(exportFrom, exportRequest, templateId, timeLimit, (result) => resolve(result), (exception, _reason) => reject(exception));
        });
    }

    private postExcelExportWithCallbacks(exportFrom: string, exportRequest: ExportRequest, templateId: string | null | undefined, timeLimit: number | undefined, onSuccess?: (result: string) => void, onFail?: (exception: string | string | string | string, reason: string) => void) {
        ...
        if (timeLimit === null)
            throw new Error("The parameter 'timeLimit' cannot be null.");
        else if (timeLimit !== undefined)
            url_ += "timeLimit=" + encodeURIComponent("" + timeLimit) + "&";
        url_ = url_.replace(/[?&]$/, "");
...
export class SessionClient extends APIClientBase {
    ...
    private getTaskStateWithCallbacks(taskID: string, onSuccess?: (result: string) => void, onFail?: (exception: string | string | string | string, reason: string) => void) {
    ...
    protected processGetTaskState(xhr: any): string | null {
        const status = xhr.status;
